...
namespace Com.Bumptech.Glide.Load.Model.File_descriptor {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorResourceLoader']"
	[global::Android.Runtime.Register ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorResourceLoader", DoNotGenerateAcw=true)]
	public partial class FileDescriptorResourceLoader : global::Com.Bumptech.Glide.Load.Model.ResourceLoader, global::Com.Bumptech.Glide.Load.Model.File_descriptor.IFileDescriptorModelLoader {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorResourceLoader.Factory']"
		[global::Android.Runtime.Register ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorResourceLoader$Factory", DoNotGenerateAcw=true)]
		public partial class Factory : global::Java.Lang.Object, global::Com.Bumptech.Glide.Load.Model.IModelLoaderFactory {
			...
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorResourceLoader$Factory", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorResourceLoader.Factory']/constructor[@name='FileDescriptorResourceLoader.Factory' and count(parameter)=0]"
			[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
			...
			{
				global::Com.Bumptech.Glide.Load.Model.File_descriptor.FileDescriptorResourceLoader.Factory __this = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Model.File_descriptor.FileDescriptorResourceLoader.Factory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorResourceLoader.Factory']/method[@name='teardown' and count(parameter)=0]"
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorResourceLoader", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FileDescriptorResourceLoader); }
		}

		protected FileDescriptorResourceLoader (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorResourceLoader']/constructor[@name='FileDescriptorResourceLoader' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe FileDescriptorResourceLoader (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				__args [0] = new JValue (p0);
				if (GetType () != typeof (FileDescriptorResourceLoader)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorResourceLoader']/constructor[@name='FileDescriptorResourceLoader' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='com.bumptech.glide.load.model.ModelLoader&lt;android.net.Uri, android.os.ParcelFileDescriptor&gt;']]"
		[Register (".ctor", "(Landroid/content/Context;Lcom/bumptech/glide/load/model/ModelLoader;)V", "")]
		public unsafe FileDescriptorResourceLoader (global::Android.Content.Context p0, global::Com.Bumptech.Glide.Load.Model.IModelLoader p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
