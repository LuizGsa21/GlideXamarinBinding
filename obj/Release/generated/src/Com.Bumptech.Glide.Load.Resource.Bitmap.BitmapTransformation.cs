...
namespace Com.Bumptech.Glide.Load.Resource.Bitmap {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.resource.bitmap']/class[@name='BitmapTransformation']"
	[global::Android.Runtime.Register ("com/bumptech/glide/load/resource/bitmap/BitmapTransformation", DoNotGenerateAcw=true)]
	public abstract partial class BitmapTransformation : global::Java.Lang.Object, global::Com.Bumptech.Glide.Load.ITransformation {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/bumptech/glide/load/resource/bitmap/BitmapTransformation", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BitmapTransformation); }
		}

		protected BitmapTransformation (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.resource.bitmap']/class[@name='BitmapTransformation']/constructor[@name='BitmapTransformation' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe BitmapTransformation (global::Android.Content.Context p0)
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.resource.bitmap']/class[@name='BitmapTransformation']/constructor[@name='BitmapTransformation' and count(parameter)=1 and parameter[1][@type='com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool']]"
...
#pragma warning restore 0169
		...
		public abstract string Id {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.resource.bitmap']/class[@name='BitmapTransformation']/method[@name='getId' and count(parameter)=0]"
	...
	[global::Android.Runtime.Register ("com/bumptech/glide/load/resource/bitmap/BitmapTransformation", DoNotGenerateAcw=true)]
	internal partial class BitmapTransformationInvoker : BitmapTransformation, global::Com.Bumptech.Glide.Load.ITransformation {

		public BitmapTransformationInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (BitmapTransformationInvoker); }
		}
		...
		protected override unsafe global::Android.Graphics.Bitmap Transform (global::Com.Bumptech.Glide.Load.Engine.Bitmap_recycle.IBitmapPool p0, global::Android.Graphics.Bitmap p1, int p2, int p3)
		{
			...
			try {
				...
				global::Android.Graphics.Bitmap __ret = global::Java.Lang.Object.GetObject<global::Android.Graphics.Bitmap> (JNIEnv.CallObjectMethod  (Handle, id_transform_Lcom_bumptech_glide_load_engine_bitmap_recycle_BitmapPool_Landroid_graphics_Bitmap_II, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
