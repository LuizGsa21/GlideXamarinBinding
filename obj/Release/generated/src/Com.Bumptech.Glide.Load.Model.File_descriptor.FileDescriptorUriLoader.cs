...
namespace Com.Bumptech.Glide.Load.Model.File_descriptor {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorUriLoader']"
	[global::Android.Runtime.Register ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorUriLoader", DoNotGenerateAcw=true)]
	public partial class FileDescriptorUriLoader : global::Com.Bumptech.Glide.Load.Model.UriLoader, global::Com.Bumptech.Glide.Load.Model.File_descriptor.IFileDescriptorModelLoader {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorUriLoader.Factory']"
		[global::Android.Runtime.Register ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorUriLoader$Factory", DoNotGenerateAcw=true)]
		public partial class Factory : global::Java.Lang.Object, global::Com.Bumptech.Glide.Load.Model.IModelLoaderFactory {
			...
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorUriLoader$Factory", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorUriLoader.Factory']/constructor[@name='FileDescriptorUriLoader.Factory' and count(parameter)=0]"
			[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
			...
			{
				global::Com.Bumptech.Glide.Load.Model.File_descriptor.FileDescriptorUriLoader.Factory __this = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Model.File_descriptor.FileDescriptorUriLoader.Factory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorUriLoader.Factory']/method[@name='teardown' and count(parameter)=0]"
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/bumptech/glide/load/model/file_descriptor/FileDescriptorUriLoader", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FileDescriptorUriLoader); }
		}

		protected FileDescriptorUriLoader (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorUriLoader']/constructor[@name='FileDescriptorUriLoader' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe FileDescriptorUriLoader (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				__args [0] = new JValue (p0);
				if (GetType () != typeof (FileDescriptorUriLoader)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Bumptech.Glide.Load.Model.File_descriptor.FileDescriptorUriLoader __this = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Model.File_descriptor.FileDescriptorUriLoader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Android.Content.Context p0 = global::Java.Lang.Object.GetObject<global::Android.Content.Context> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorUriLoader']/method[@name='getAssetPathFetcher' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String']]"
		...
		protected override unsafe global::Com.Bumptech.Glide.Load.Data.IDataFetcher GetAssetPathFetcher (global::Android.Content.Context p0, string p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Data.IDataFetcher> (JNIEnv.CallObjectMethod  (Handle, id_getAssetPathFetcher_Landroid_content_Context_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Data.IDataFetcher> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAssetPathFetcher", "(Landroid/content/Context;Ljava/lang/String;)Lcom/bumptech/glide/load/data/DataFetcher;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.model.file_descriptor']/class[@name='FileDescriptorUriLoader']/method[@name='getLocalUriFetcher' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.net.Uri']]"
		...
		protected override unsafe global::Com.Bumptech.Glide.Load.Data.IDataFetcher GetLocalUriFetcher (global::Android.Content.Context p0, global::Android.Net.Uri p1)
		{
			...
			try {
				...
				global::Com.Bumptech.Glide.Load.Data.IDataFetcher __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Data.IDataFetcher> (JNIEnv.CallObjectMethod  (Handle, id_getLocalUriFetcher_Landroid_content_Context_Landroid_net_Uri_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Data.IDataFetcher> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getLocalUriFetcher", "(Landroid/content/Context;Landroid/net/Uri;)Lcom/bumptech/glide/load/data/DataFetcher;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
