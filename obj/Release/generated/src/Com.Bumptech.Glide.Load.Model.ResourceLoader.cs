...
namespace Com.Bumptech.Glide.Load.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.model']/class[@name='ResourceLoader']"
	[global::Android.Runtime.Register ("com/bumptech/glide/load/model/ResourceLoader", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public partial class ResourceLoader : global::Java.Lang.Object, global::Com.Bumptech.Glide.Load.Model.IModelLoader {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/bumptech/glide/load/model/ResourceLoader", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model']/class[@name='ResourceLoader']/constructor[@name='ResourceLoader' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='com.bumptech.glide.load.model.ModelLoader&lt;android.net.Uri, T&gt;']]"
		[Register (".ctor", "(Landroid/content/Context;Lcom/bumptech/glide/load/model/ModelLoader;)V", "")]
		public unsafe ResourceLoader (global::Android.Content.Context p0, global::Com.Bumptech.Glide.Load.Model.IModelLoader p1)
		...
		static IntPtr id_ctor_Landroid_content_res_Resources_Lcom_bumptech_glide_load_model_ModelLoader_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model']/class[@name='ResourceLoader']/constructor[@name='ResourceLoader' and count(parameter)=2 and parameter[1][@type='android.content.res.Resources'] and parameter[2][@type='com.bumptech.glide.load.model.ModelLoader&lt;android.net.Uri, T&gt;']]"
		...
		static Delegate cb_getResourceFetcher_Ljava_lang_Integer_II;
#pragma warning disable 0169
		static Delegate GetGetResourceFetcher_Ljava_lang_Integer_IIHandler ()
		{
			if (cb_getResourceFetcher_Ljava_lang_Integer_II == null)
				cb_getResourceFetcher_Ljava_lang_Integer_II = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, int, int, IntPtr>) n_GetResourceFetcher_Ljava_lang_Integer_II);
			return cb_getResourceFetcher_Ljava_lang_Integer_II;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_getResourceFetcher_Ljava_lang_Integer_II;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.model']/class[@name='ResourceLoader']/method[@name='getResourceFetcher' and count(parameter)=3 and parameter[1][@type='java.lang.Integer'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("getResourceFetcher", "(Ljava/lang/Integer;II)Lcom/bumptech/glide/load/data/DataFetcher;", "GetGetResourceFetcher_Ljava_lang_Integer_IIHandler")]
		public virtual unsafe global::Com.Bumptech.Glide.Load.Data.IDataFetcher GetResourceFetcher (global::Java.Lang.Integer p0, int p1, int p2)
		{
			if (id_getResourceFetcher_Ljava_lang_Integer_II == IntPtr.Zero)
				id_getResourceFetcher_Ljava_lang_Integer_II = JNIEnv.GetMethodID (class_ref, "getResourceFetcher", "(Ljava/lang/Integer;II)Lcom/bumptech/glide/load/data/DataFetcher;");
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Data.IDataFetcher> (JNIEnv.CallObjectMethod  (Handle, id_getResourceFetcher_Ljava_lang_Integer_II, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Data.IDataFetcher> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getResourceFetcher", "(Ljava/lang/Integer;II)Lcom/bumptech/glide/load/data/DataFetcher;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
