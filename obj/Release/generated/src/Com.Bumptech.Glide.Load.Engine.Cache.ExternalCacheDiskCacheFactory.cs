...
namespace Com.Bumptech.Glide.Load.Engine.Cache {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.engine.cache']/class[@name='ExternalCacheDiskCacheFactory']"
	[global::Android.Runtime.Register ("com/bumptech/glide/load/engine/cache/ExternalCacheDiskCacheFactory", DoNotGenerateAcw=true)]
	public sealed partial class ExternalCacheDiskCacheFactory : global::Com.Bumptech.Glide.Load.Engine.Cache.DiskLruCacheFactory {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/bumptech/glide/load/engine/cache/ExternalCacheDiskCacheFactory", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ExternalCacheDiskCacheFactory); }
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.engine.cache']/class[@name='ExternalCacheDiskCacheFactory']/constructor[@name='ExternalCacheDiskCacheFactory' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe ExternalCacheDiskCacheFactory (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (ExternalCacheDiskCacheFactory)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.engine.cache']/class[@name='ExternalCacheDiskCacheFactory']/constructor[@name='ExternalCacheDiskCacheFactory' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='int']]"
		[Register (".ctor", "(Landroid/content/Context;I)V", "")]
		public unsafe ExternalCacheDiskCacheFactory (global::Android.Content.Context p0, int p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.engine.cache']/class[@name='ExternalCacheDiskCacheFactory']/constructor[@name='ExternalCacheDiskCacheFactory' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int']]"
		[Register (".ctor", "(Landroid/content/Context;Ljava/lang/String;I)V", "")]
		public unsafe ExternalCacheDiskCacheFactory (global::Android.Content.Context p0, string p1, int p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
