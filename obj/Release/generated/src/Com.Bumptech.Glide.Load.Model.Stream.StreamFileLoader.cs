...
namespace Com.Bumptech.Glide.Load.Model.Stream {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.model.stream']/class[@name='StreamFileLoader']"
	[global::Android.Runtime.Register ("com/bumptech/glide/load/model/stream/StreamFileLoader", DoNotGenerateAcw=true)]
	public partial class StreamFileLoader : global::Com.Bumptech.Glide.Load.Model.FileLoader, global::Com.Bumptech.Glide.Load.Model.Stream.IStreamModelLoader {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.bumptech.glide.load.model.stream']/class[@name='StreamFileLoader.Factory']"
		[global::Android.Runtime.Register ("com/bumptech/glide/load/model/stream/StreamFileLoader$Factory", DoNotGenerateAcw=true)]
		public partial class Factory : global::Java.Lang.Object, global::Com.Bumptech.Glide.Load.Model.IModelLoaderFactory {
			...
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/bumptech/glide/load/model/stream/StreamFileLoader$Factory", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.stream']/class[@name='StreamFileLoader.Factory']/constructor[@name='StreamFileLoader.Factory' and count(parameter)=0]"
			[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
			...
			{
				global::Com.Bumptech.Glide.Load.Model.Stream.StreamFileLoader.Factory __this = global::Java.Lang.Object.GetObject<global::Com.Bumptech.Glide.Load.Model.Stream.StreamFileLoader.Factory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.model.stream']/class[@name='StreamFileLoader.Factory']/method[@name='build' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='com.bumptech.glide.load.model.GenericLoaderFactory']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.bumptech.glide.load.model.stream']/class[@name='StreamFileLoader.Factory']/method[@name='teardown' and count(parameter)=0]"
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/bumptech/glide/load/model/stream/StreamFileLoader", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (StreamFileLoader); }
		}

		protected StreamFileLoader (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.stream']/class[@name='StreamFileLoader']/constructor[@name='StreamFileLoader' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe StreamFileLoader (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				__args [0] = new JValue (p0);
				if (GetType () != typeof (StreamFileLoader)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.bumptech.glide.load.model.stream']/class[@name='StreamFileLoader']/constructor[@name='StreamFileLoader' and count(parameter)=1 and parameter[1][@type='com.bumptech.glide.load.model.ModelLoader&lt;android.net.Uri, java.io.InputStream&gt;']]"
		[Register (".ctor", "(Lcom/bumptech/glide/load/model/ModelLoader;)V", "")]
		public unsafe StreamFileLoader (global::Com.Bumptech.Glide.Load.Model.IModelLoader p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
